...
import com.moviemania.data.remote.WITH_GENRES
import retrofit2.HttpException
import java.io.IOException

class MoviesByGenrePageSource(val dataRepository: DataRepository, val id: Int) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieResponseModel.MovieModel> {
        ...
        hashMap[WITH_GENRES] = id

        return try {
            val response = dataRepository.getMoviesByGenre(hashMap)
